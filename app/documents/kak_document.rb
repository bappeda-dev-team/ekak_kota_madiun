class KakDocument
  ...
  def judul_program
    ...
    table(tabel_program_kegiatan, column_widths: { 0=> 150,1 => 12 }, cell_style: { size: 8, border_width: 0 }, width:bounds.width)
  end
  ...
  def export_from_there
   ...
   move_down 30
    ...
    @program_kegiatan.sasarans.where.not(program_kegiatan: nil).each.with_index(1) do |sasaran, index|
      ...
      tabel_sasaran =make_table(sasaran_judul, column_widths: { 0=> 17, 2=> 13 }, cell_style: { size: 8, border_width: 0 }, width:bounds.width)
      tabel_dasar_hukum =make_table(dasar_hukum, column_widths: { 0=> 17, 1=>17, 2=> 88, 3=> 12  }, cell_style: { size: 8, border_width: 0, :overflow => :expand }, width:bounds.width)
      tabel_gambaran_umum =make_table(gambaran_umum, column_widths: { 0=> 17, 1=>17, 2=> 88, 3=> 12  }, cell_style: { size: 8, border_width: 0, :overflow => :expand }, width:bounds.width)
      tabel_penerima_manfaat =make_table(penerima_manfaat, column_widths: { 0=> 17, 1=>17, 2=> 88, 3=> 12  }, cell_style: { size: 8, border_width: 0, :overflow => :expand }, width:bounds.width)
      tabel_data_terpilah =make_table(data_terpilah, column_widths: { 0=> 17, 1=>17, 2=> 88, 3=> 12  }, cell_style: { size: 8, border_width: 0, :overflow => :expand }, width:bounds.width)
      tabel_permasalahan =make_table(permasalahan, column_widths: { 0=> 17, 1=>17, 2=> 88, 3=> 12  }, cell_style: { size: 8, border_width: 0, :overflow => :expand }, width:bounds.width)
      tabel_rincian =make_table(rincian_sasaran, column_widths: { 0=> 17, 1=>17, 2=> 88, 3=> 12  }, cell_style: { size: 8, border_width: 0, :overflow => :expand }, width:bounds.width)
      tabel_rencana_aksi_judul =make_table(rencana_aksi_judul, column_widths: { 0=> 17, 1=>17}, cell_style: { size: 8, border_width: 0 })
     ...
     move_down 10
      ...
      tabel_renaksi =make_table(data_rencana_aksi, column_widths: { 0 => 18, 1 => 130, 14 => 30 }, cell_style: { size: 6, align: :left }, width:bounds.width)
   ...
   bounding_box([pdf.bounds.width - 300,cursor - 10], width:bounds.width - 200) do
     ...
     move_down 50
     text "<u>#{@program_kegiatan.opd.nama_kepala || '!!belum disetting'}</u>", size: 8, align: :center, inline_format: true
