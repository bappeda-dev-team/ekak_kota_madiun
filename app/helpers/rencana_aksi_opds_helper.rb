module RencanaAksiOpdsHelper
  def rowspan_renaksi_opd(sasaran, renaksi_row)
  ...
  def indikator_rencana_aksi_opd(sasaran, rowspan)
    ...
    "
      <td rowspan='#{rowspans}' class='text-wrap indikator-sasaran'>#{indikator&.indikator_kinerja}</td>
      <td rowspan='#{rowspans}' class='text-center indikator-sasaran'>#{indikator&.target}</td>
      <td rowspan='#{rowspans}' class='text-center indikator-sasaran'>#{indikator&.satuan}</td>
    ".html_safe
  end
