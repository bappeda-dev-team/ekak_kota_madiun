      ...
      json.children isu_asli do |strategi|
        ...
        if strategi.instance_of?(Pohon)
          json.children strategi.strategis do |strategic|
            ...
            json.children strategic.strategi_eselon_tigas.where(role: 'eselon_2b') do |strategic2|
              json.id "#{strategic2.id}_strategic2"
              json.name "Strategic Objective 2"
              json.type "strategic_objective_2"
              json.description strategic2.strategi_dan_nip
              json.children strategic2.strategi_eselon_tigas.where(role: 'eselon_3') do |tactical|
