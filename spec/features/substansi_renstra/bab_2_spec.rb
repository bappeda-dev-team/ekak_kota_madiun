  ...
  describe 'aset opd' do
    context 'with opd and tahun selected' do
      ...
      it 'able to tambah aset opd', js: true do
        ...
        find_all(:xpath, '//*[@id="aset_kondisi"]').each do |kondisi|
          kondisi.click
        end
        find(:xpath, '//*[@id="aset_tahun_awal"]').set('2018')
        find(:xpath, '//*[@id="aset_tahun_akhir"]').set('2025')
        find(:xpath, '//*[@id="aset_keterangan"]').set('3 kendaraan kondisi baik,
                                                        1 kendaraan buruk,
                                                        1 kendaraan cukup baik')
        ...
        expect(page).to have_selector('td.aset_keterangan', text: '3 kendaraan kondisi baik,
                                                                   1 kendaraan buruk,
                                                                   1 kendaraan cukup baik')
      end
    end
